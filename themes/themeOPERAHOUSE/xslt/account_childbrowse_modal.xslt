...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
  ...
  <xsl:template match="sqroot/body/bodyContent">
    ...
    <div class="modal-footer" id="notiModalFooter">
      <button type="button" class="btn btn-primary btn-raised"  onclick="savethemeOPERAHOUSE('accountdetail', '{/sqroot/body/bodyContent/form/info/GUID/.}',  '', 'form{/sqroot/body/bodyContent/form/info/code/.}')">Save</button>
