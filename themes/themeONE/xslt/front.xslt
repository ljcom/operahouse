...
>
  ...
  <xsl:template match="/">
    <script>
      ...
      //loadStyle('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css');

      //loadStyle('https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css');
      loadStyle('OPHContent/themes/themeONE/scripts/daterangepicker/daterangepicker.css');
      loadStyle('OPHContent/themes/themeONE/scripts/datepicker/datepicker3.css');
      loadStyle('OPHContent/themes/themeONE/scripts/iCheck/all.css');
      loadStyle('OPHContent/themes/themeONE/scripts/colorpicker/bootstrap-colorpicker.min.css');
      loadStyle('OPHContent/themes/themeONE/scripts/timepicker/bootstrap-timepicker.min.css');
      loadStyle('OPHContent/themes/themeONE/scripts/select2/select2.min.css');
      loadStyle('OPHContent/themes/themeONE/scripts/admin-LTE/css/AdminLTE.min.css');
      loadStyle('OPHContent/themes/themeONE/scripts/admin-LTE/css/skins/_all-skins.min.css');
      loadStyle('OPHContent/themes/themeONE/styles/custom-me.css');

      loadScript('OPHContent/themes/themeONE/scripts/jQuery/jquery-2.2.3.min.js');
      loadScript('OPHContent/themes/themeONE/scripts/bootstrap/js/bootstrap.min.js');
      loadScript('OPHContent/themes/themeONE/scripts/select2/select2.full.min.js');
      loadScript('OPHContent/themes/themeONE/scripts/input-mask/jquery.inputmask.js');
      loadScript('OPHContent/themes/themeONE/scripts/input-mask/jquery.inputmask.date.extensions.js');
      loadScript('OPHContent/themes/themeONE/scripts/input-mask/jquery.inputmask.extensions.js');
      loadScript('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js');
      //loadScript('OPHContent/themes/themeONE/scripts/daterangepicker/daterangepicker.js');
      loadScript('OPHContent/themes/themeONE/scripts/datepicker/bootstrap-datepicker.js');
      loadScript('OPHContent/themes/themeONE/scripts/colorpicker/bootstrap-colorpicker.min.js');
      loadScript('OPHContent/themes/themeONE/scripts/timepicker/bootstrap-timepicker.min.js');
            ...
            <li class="dropdown messages-menu visible-phone" style="margin-right:20px;">
              ...
              <li> -->
                ...
                <li>
                  ...
                  <a href="account.html">
                    <ix class="fa fa-user"></ix> Iman.Satyagraha
                  </a>
                </li>
                <xsl:apply-templates select="sqroot/header/menus/menu[@code='primary']" />
