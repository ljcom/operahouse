...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <script>
      ...
      loadStyle('https://fonts.googleapis.com/css?family=Oxygen:400,300,700');
      ...
      if (getQueryVariable("GUID") != undefined &amp;&amp; getQueryVariable("GUID") != '' &amp;&amp; getQueryVariable("code")=='causerfron'){
      ChangePages('_profile', 'contentAccount');
      }else if (getQueryVariable("code")=='causeraddr'){
      ChangePages('_address', 'contentAccount');
      }else if (getQueryVariable("code")=='tapcs3'){
        if (getQueryVariable("GUID") != undefined &amp;&amp; getQueryVariable("GUID") != '') {
          ...
          var filterkey = "carolGUID = '<xsl:value-of select="sqroot/header/info/user/userGUID/." />' and status = 100";
