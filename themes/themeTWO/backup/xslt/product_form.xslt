...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="formCols/formCol">
    ...
    <form action="#" method="post" id="productform">
      ...
      <span class="input-group" style="margin-bottom:20px;">
        <input type="number" id="Availaible" class="form-control" name="Availaible" style="width:70px;text-align:center" value="1" />
      </span>
      <div class="btn-area">
  ...
  <xsl:template match="formRows/formRow">
    ...
    <xsl:if test="fields/field[@fieldName = 'price']">
      <h3>
        Rp. <xsl:value-of select="format-number(fields/field[@fieldName = 'price']/textBox/value/., '#,##0', 'dot-dec')" />
      </h3>
    ...
    <xsl:if test="fields/field[@fieldName = 'Description']">
      <p>
        Description : <br/><xsl:value-of select="fields/field[@fieldName = 'Description']/textBox/value/." />
      </p>
    </xsl:if>
