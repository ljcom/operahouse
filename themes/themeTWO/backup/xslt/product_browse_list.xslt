    ...
    <div class="col-xs-12">
      <div class="media">
        <div class="media-left">
          ...
          <span class="maskingImage"><a href="index.aspx?code=maprodfron&amp;GUID={@GUID}" class="btn viewBtn">View</a></span>
        </div>
        <div class="media-body">
          <h4 class="media-heading"><a href="index.aspx?code=maprodfron&amp;GUID={@GUID}">
          ...
          <div style="height:40px;">
            <!--<xsl:choose>
              <xsl:when test="(fields/field[@caption = 'discount']/.)!= '0'">
                <h3 style="text-decoration:line-through; font-size:12px; margin:0">Rp. <xsl:value-of select="format-number(fields/field[@caption = 'price']/., '#,##0', 'dot-dec')" /></h3>
