    ...
    <xsl:choose>
      <xsl:when test="((fields/field[@caption = 'PARNCTGRGUID']/.) !='' or (fields/field[@caption = 'PARNBRANGUID']/.) !='') and (fields/field[@caption = 'isParent']/.) ='1' ">
        <li style="border-bottom:none;">
          <a data-toggle="collapse" href="#{@GUID}_menu" class="top-envi-lv2"  onclick="LoadNewPart('home_browse_menu_sidebar', '{@GUID}_menus', '{$code}', '', '{@GUID}');">
            ...
            <xsl:choose>
              <xsl:when test="(fields/field[@caption = 'Link']/.) !=''">
                <br/><br/><span data-toggle="tooltip" title="Go to this Link" onclick="NewTabAnotherPage('http://{fields/field[@caption = 'Link']/.}')" style="font-size:10px; margin-left:22px; ">
      ...
      <xsl:when test="((fields/field[@caption = 'PARNCTGRGUID']/.) !='' or (fields/field[@caption = 'PARNBRANGUID']/.) !='') and (fields/field[@caption = 'isParent']/.) ='0' ">
        <li>
          <a data-toggle="collapse" href="#{@GUID}_menu" class="top-envi-lv2" onclick="goToAnotherPage('index.aspx?code=maprodfron&amp;bSearchText={@GUID}')">
            <span style="margin-right:10px; font-size:9px;">➤</span>
            <xsl:value-of select="fields/field[@caption = 'Name']/." />
          </a>
          <div id="{@GUID}_menu" class="panel-collapse collapse">
      ...
      <xsl:otherwise>
        <div class="panel top-menu-onphone" style="border-radius:0; margin-top:0;" >
          ...
          <a class="top-envi" data-toggle="collapse" href="#{@GUID}_menu" data-parent="#accordion2"  onclick="LoadNewPart('home_browse_menu_sidebar', '{@GUID}_menus', '{$code}', '', '{@GUID}');">
            <!--<ix>
              <img src="{icon/img/.}" style="width:15px; margin-right:8px;" />
            </ix>-->
            <!--<span style="margin-right:10px; font-size:9px;">➤</span>-->
            <span onclick="goToAnotherPage('index.aspx?code=maprodfron&amp;bSearchText={@GUID}')">
              <xsl:value-of select="fields/field[@caption = 'Name']/." />
            </span>
            <xsl:apply-templates select="fields/field[@caption = 'isParent']" />
