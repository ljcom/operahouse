...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <script>
      ...
      loadStyle('https://fonts.googleapis.com/css?family=Oxygen');
      loadStyle('https://cdn.linearicons.com/free/1.0.0/icon-font.min.css');
      ...
      <div class="navTop text-center">
        <div class="container">
          ...
          <div class="navTop-middle" >
            <div class="searchBox" style="margin-left:15%;">
          ...
          <div class="dropdown cart-dropdown" id="carttop" onclick="changePopUpToLogin()">
            Loading Please Wait...
            <script>
  ...
  <xsl:template match="sqroot/header/filters/filter">
    <div class="panel-group">
      <p class="" style="color:white; background:#37acb2;  display:block; font-size:15px; padding:5px 10px;  margin-bottom:0px;">
          ...
          <div class="panel-group" id="accordion2">
            ...
            <div id="{caption/.}Menu">
              <script>
                ...
                LoadNewPart('home_browse_menu_sidebar', id, code, prnt, '');
                }
              </script>
            </div>
          </div>
