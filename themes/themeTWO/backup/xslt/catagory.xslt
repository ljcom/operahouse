  ...
  <xsl:template match="sqroot/body/bodyContent/browse/content/row">
    ...
    <xsl:choose>
      <xsl:when test="((fields/field[@caption = 'PARNCTGRGUID']/.) !='' or (fields/field[@caption = 'PARNBRANGUID']/.) !='') and (fields/field[@caption = 'isParent']/.) ='1' ">
        <li>
          <a data-toggle="collapse" href="#{@GUID}_menu" class="top-envi-lv2"  onclick="LoadNewPart('catagory', '{@GUID}_menus', '{$code}', '', '{@GUID}');">
      ...
      <xsl:otherwise>
        <div class="panel top-menu-onphone" style="border-radius:0; margin-top:0;" >
          ...
          <a class="top-envi" data-toggle="collapse" href="#{@GUID}_menu" data-parent="#accordion2"  onclick="LoadNewPart('catagory', '{@GUID}_menus', '{$code}', '', '{@GUID}');">
            <!--<ix>
              <img src="{icon/img/.}" style="width:15px; margin-right:8px;" />
            </ix>-->
            <!--<span style="margin-right:10px; font-size:9px;">➤</span>-->
            <span onclick="goToAnotherPage('index.aspx?code=maprodfron&amp;bSearchText={@GUID}')"><xsl:value-of select="fields/field[@caption = 'Name']/." /></span>
            <xsl:apply-templates select="fields/field[@caption = 'isParent']" /> 
