  ...
  <xsl:template match="/">
    <a href="#" class="dropdown-toggle shop-cart" data-toggle="dropdown">
      <span class="hidden-xs">
        <span style="padding:11px 20px; float:left; background:#47BAC1; color:white;margin:0;  margin-right:10px; margin-left:-16px;font-size:20px;">
          <ix class="fa fa-shopping-cart"></ix>
          
        </span>
        <span id="cartTotalQty" class="cart-total">Your Cart (0)</span>
        <br/>
        <span id="cartTotalSales" class="cart-price"> Rp. <span id="totalcart">0</span> </span>
        <div id="LimitUsers" style="margin-top:-65px; margin-left:-15px;"> &#xA0; </div>
        <br/>
      </span>
    </a>
      ...
      <li>
        <div class="btn-group" role="group" aria-label="..." id="buttoncarttop" >
          ...
          <script>
            ...
            document.getElementById("carttop_Shopping").href = '?code=tapcs1&amp;GUID='+cartID;
            document.getElementById("carttop_Checkout").href = '?code=tapcs2&amp;GUID='+cartID;
      ...
      <a href="?code=maprodfron&amp;GUID={fields/field[@caption = 'EVENPSKUGUID']/.}">
        <div class="media">
          <div style="height:50px; width:50px; float:left; margin-right:10px; overflow:hidden; text-align:center; background:white; border:2px solid #37acb2; ">
            <img style="max-height:35px; margin-top:5px; width: auto;" src="{fields/field[@caption = 'productphotos']}" alt="products-img" />
          </div>
