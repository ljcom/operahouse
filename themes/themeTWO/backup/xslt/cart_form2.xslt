                    ...
                    <form action="" class="row" method="POST" role="form">
                      ...
                      <div class="col-xs-12">
                        <div class="well well-lg clearfix">
                          <ul class="pager">
                            <li class="previous"><a href="?code=pcs1&amp;GUID={sqroot/body/bodyContent/form/info/GUID/.}">back</a></li>
                            <li class="next"><a href="#tab4default"  data-toggle="tab"  onclick="#">Continue</a></li>
                          </ul>
                        </div>
                      </div>
                    </form>
                  ...
                  <div class="tab-pane fade" id="tab4default">
                    ...
                    <div class="col-sm-6 col-xs-12">
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <address>
                            <strong id=""><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage[@pageNo='1']/formSections/formSection[@sectionNo='1']/formCols/formCol[@colNo='1']/formRows/formRow[@rowNo='1']/fields/field/textBox/value/." /></strong><br />
                            <span id="PCSO_CustomerAddress_browse">a</span><br />
                            <span id="PCSO_City_browse">b</span> <br/>
                        ...
                        <div class="totalAmountArea">
                          <div class="col-sm-4 col-sm-offset-8 col-xs-12">
                            <ul class="list-unstyled">
                              <li>
                                Sub Total <span>Rp.  <xsl:value-of select="format-number(sqroot/body/bodyContent/form/formPages/formPage[@pageNo='1']/formSections/formSection/formCols/formCol[@colNo='5']/formRows/formRow[@rowNo='2']/fields/field/textBox/value/., '#,##0', 'dot-dec')" /></span>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div class="well well-lg clearfix">
                        <ul class="pager">
                          <form id="cartForm" method="POST">
                            ...
                            <li class="previous"><a  data-toggle="tab"  href="#tab1default">back</a></li>
                            <li class="next">
                              <a style="cursor:pointer;" onclick="SaveData('PCS1','cartForm', 'index.aspx?code=pcs3')">
                                Confirm
                              </a>
                            </li>
                          </form>
