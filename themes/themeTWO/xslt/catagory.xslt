  ...
  <xsl:template match="sqroot/body/bodyContent/browse/content/row">
    ...
    <xsl:choose>
      ...
      <xsl:when test="((fields/field[@caption = 'PARNCTGRGUID']/.) !='' or (fields/field[@caption = 'PARNBRANGUID']/.) !='') and (fields/field[@caption = 'isParent']/.) ='0' ">
        <li>
          <a data-toggle="collapse" href="#{@GUID}_menu" class="top-envi-lv2" onclick="goToAnotherPage('index.aspx?code=maprodfron&amp;bSearchText={@GUID}');  changePlusMinus(this);">
            <!--<span style="margin-right:10px; font-size:9px;">➤</span>--> 
            <xsl:value-of select="fields/field[@caption = 'Name']/." />
          </a>
          <div id="{@GUID}_menu" class="panel-collapse collapse">
      ...
      <xsl:otherwise>
        <div class="panel top-menu-onphone" style="border-radius:0; margin-top:0;" >
          ...
          <a class="top-envi" data-toggle="collapse" href="#{@GUID}_menu" data-parent="#accordion2"  onclick="LoadNewPart('catagory', '{@GUID}_menus', '{$code}', '', '{@GUID}', '1', '200');  changePlusMinus(this);">
            ...
            <!--<span style="margin-right:10px; font-size:9px;">➤</span>-->
            <span onclick="goToAnotherPage('index.aspx?env=front&amp;code=maprodfron&amp;bSearchText={@GUID}')"><xsl:value-of select="fields/field[@caption = 'Name']/." /></span>
            <xsl:apply-templates select="fields/field[@caption = 'isParent']" /> 
